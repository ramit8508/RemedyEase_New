...
// Add placeholder doctor images or import actual images if available
      ...
      <div className="services">
        ...
        <div className="service_cards">
          <div className="service_card">
            <img src={service1} alt="Service 1" className="service_image1" />
          ...
          <div className="service_card">
            <img src={service2} alt="Service 2" className="service_image2" />
          ...
          <div className="service_card">
            <img src={service3} alt="Service 3" className="service_image3" />
          ...
          <div className="service_card">
            <img src={service4} alt="Service 4" className="service_image4" />
