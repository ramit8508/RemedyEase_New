...
const registerUser = asyncHandler(async (req, res) => {
    ...
    if ([fullname, email, password, confirmPassword].some((field) => !field || field.trim() === "")) {
...
const getUserAppointments = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            return res.status(200).json(new ApiResponse(200, [], "No appointments found or error fetching them"));
        }
    } catch (error) {
